...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: Hbt_q_lOyvuW/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: kwXM9ObmV8SV/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__uUlks)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button___8Ogpd)}
            label={"Open Popover"}
          />
        ),
