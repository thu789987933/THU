...
import TextInput from "../../TextInput"; // plasmic-import: 8IFg-OBjmlmk/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: opwo15s9lrtv/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: Y8VFkMUXryZW/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__inOo, {
          [sty.freeBoxiconEnd__inOOj78Kr]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__inOOsloPe]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__inOoJaaZl]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__iC91, {
            [sty.freeBoxiconStart__iC91SloPe]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__iC91JaaZl]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__vuHlD)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__mm91H, {
            [sty.freeBoxiconEnd__mm91Hj78Kr]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__mm91HsloPe]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__skKxT)}
                role={"img"}
              />
            ),
