...
import MenuPopover from "../../MenuPopover"; // plasmic-import: sl2wpRKM3gqS/component
import MenuItem from "../../MenuItem"; // plasmic-import: Du_xb4lQLSqZ/component
import MenuSection from "../../MenuSection"; // plasmic-import: ZZT_k1psAXdW/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: 4_gPAwhDMZRU/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__o7WW)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
