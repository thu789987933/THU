...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: Du_xb4lQLSqZ/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ptahG)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__paqHj)}>
            <div
              className={classNames(
                projectcss.all,
