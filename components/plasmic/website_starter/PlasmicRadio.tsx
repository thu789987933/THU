...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: xh1-5-jXMb_0/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox___4C92T)}>
        <div className={classNames(projectcss.all, sty.freeBox__cih0C)} />
      </div>
      {renderPlasmicSlot({
