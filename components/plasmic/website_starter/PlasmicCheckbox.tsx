...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: buL_eErryEu8/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: 1w-Vkb91I6df/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: PhhqDrnWBAtb/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__q3YJ)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__wDi8G)}
            role={"img"}
          />
        ) : null}
      </div>
